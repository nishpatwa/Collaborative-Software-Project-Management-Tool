...
%>
	...
	<br/>
	<form id="form1" class="form-horizontal" method="get" action="UpdateEmployeeProfile.jsp" onsubmit="validate()">
	<% while(rs1.next()){%>
	<input type="hidden" name="employee_id" value='<%=rs1.getInt("employee_id")%>'>
	<input type="hidden" name="oldemployeename" value='<%=rs1.getString("employee_name")%>'>
