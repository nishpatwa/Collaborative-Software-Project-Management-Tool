		...
		<div class="row-fluid" style="padding-top: 25px;">
		  ...
		  <div class="span9">
			<div class="page-header">
              ...
              String sql5="select messagedetail.*,login.name from messagedetail INNER JOIN login ON messagedetail.receiver_id=login.login_id   where sender_id="+loginid+" ";
			  ...
			  <div class="accordion-group">
				<div class="accordion-heading">
                                    <%     Timestamp timeReg = rs5.getTimestamp("send_date"); 
                                        String time_date = timeReg.toString();
%>
				  <div class="accordion-toggle clearfix" data-toggle="collapse" data-parent="#accordionMessage" href="#message<%=rs5.getString("message_id")%>">
					<div class="span3"><%=rs5.getString("name")%></div>
					<div class="span6"><%=rs5.getString("subject")%></div>
                                        <div class="span2"><%=time_date%></div>
					<div class="span1"><div class="btn-group">
						<a class="btn" title="delete the record" href="javascript:if (confirm('Are you sure?')) window.location.href ='DeleteMessage1.jsp?id=<%=rs5.getInt("message_id")%>';" onclick="event.stopPropagation();">
